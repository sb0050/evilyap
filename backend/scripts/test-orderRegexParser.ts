...
const cases: Case[] = [
  ...
  { text: "Je prends la rouge", expectedIntent: "UNKNOWN", expectedReference: null, expectedQuantity: 1 },
  { text: "ajoute le bleu", expectedIntent: "UNKNOWN", expectedReference: null, expectedQuantity: 1 },
  { text: "commande noir x2", expectedIntent: "UNKNOWN", expectedReference: null, expectedQuantity: 2 },
